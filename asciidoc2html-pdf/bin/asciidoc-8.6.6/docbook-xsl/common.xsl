...
<xsl:param name="navig.graphics.path">bin/asciidoc-8.6.6/images/icons/</xsl:param>
...
<xsl:param name="admon.graphics.path">bin/asciidoc-8.6.6/images/icons/</xsl:param>
...
<xsl:param name="callout.graphics.path" select="'bin/asciidoc-8.6.6/images/icons/callouts/'"/>
